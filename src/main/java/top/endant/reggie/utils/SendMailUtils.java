package top.endant.reggie.utils;
...
public class SendMailUtils {
     ...
     * @param name       收件人的姓名
     */
    public void sendQQEmail(String from_email, String pwd, String recevices, String code, String name) throws Exception {
...
//        sendMailUtils.sendQQEmail("805734828@qq.com", "wqgppsqjskmgbdaa", "752239019@qq.com", "8848", "莫已");
//    }

    public static void send(String receives,String code,String name) throws Exception {
        SendMailUtils sendMailUtils = new SendMailUtils();
        sendMailUtils.sendQQEmail("805734828@qq.com", "wqgppsqjskmgbdaa",receives,code,name);
    }
}
